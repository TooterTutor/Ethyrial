...
public class BeastialAspect extends Spell implements AutoRegisterSpell {
    public BeastialAspect(Ethyrial plugin) {
        super(Ethyrial.getInstance(),
                "beastialaspect",
                "Beastial Aspect",
                "Gain temporary power by channeling animal traits.",
                50,
                400,
